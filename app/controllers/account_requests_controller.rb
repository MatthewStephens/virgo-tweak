require '/usr/local/projects/virgo/lib/firehose/libraries'
...
require '/usr/local/projects/virgo/lib/firehose/common'
  ...
  def verify_account
    if current_user.nil?
      if params[:id]
        ...
        flash[:error] = "<p>Please <a class='btn small' href='/login?redirect=recall&id=#{params[:id]}'>sign in with NetBadge</a> to request this item.</p><p>Don't have a U.Va. account?  Sign in as a <a class='btn small' href='/patron_login?redirect=recall&id=#{params[:id]}'>non-U.Va. user</a>.</p>".html_safe
        redirect_to catalog_path(params[:id]) and return
      else
        flash[:error] = "<p>Please <a class='btn small' href='/login'>sign in with NetBadge</a>.</p><p>Don't have a U.Va. account?  Sign into as a <a class='btn small' href='/patron_login'>non-U.Va. user</a>.</p>".html_safe
