...
jQuery(document).ready(function($) {    
    ...
    function positionDialog(dialog) {
      ...
      dialog.dialog("open").dialog("moveToTop");
			...
			// scroll to the dialog (for IE) sans some 30px padding
			window.scrollTo(0, dialog.offset().top - 30);
	...
	$('#close_button').live('click', function() {
		// Close the facet dialog box whenever the close button is clicked.
