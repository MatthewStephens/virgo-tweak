module UVA
  class DocumentImageLoader
    ...
    def prepare_harvest(docs)
      docs.each do |doc|
        doc_image = UVA::DocumentImage.new(doc)
        harvest!(doc_image)
        end
    end
    ...
    def find_bookcovers(doc)
      ...
      ri = Blacklight::RemoteImage::Finder.new(:use_cache=>false)
      ri.add_finder :syndetics, Blacklight::Syndetics::Bookcovers.new
      ri.add_finder :google, Blacklight::Google::Bookcovers.new
      ri.add_finder :library_thing, Blacklight::LibraryThing::Bookcovers.new
    ...
    def find_albumcovers(ids)
      ...
      ri = Blacklight::RemoteImage::Finder.new(:use_cache=>false)
      ri.add_finder :last_fm, Blacklight::LastFM::AlbumCovers.new
      ri.find(:mbid=>ids)
    end
    ...
    def music_brainz_ids(doc)
      ...
      mb = Blacklight::MusicBrainz::ArtistSearch.new
